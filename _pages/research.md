...
author_profile: true
---
<div class="kar-project-grid">

  <!-- Project 1 -->
  <div class="kar-project-card">
    <div class="kar-project-card__title">
      <a href="#" class="kar-project-link">
        Interrelationship between pedestrian streetscape, perceptions, and willingness
      </a>
    </div>

    <div class="kar-project-card__desc">
    ...
    <a href="/images/TRB_Poster_2026.jpg" class="kar-project-link" target="_blank">
      <img src="/images/TRB_Poster_2026.jpg" class="kar-project-card__img">
    </a>

    <div class="kar-project-card__caption">
  ...
  <div class="kar-project-card">
    ...
    <a href="/images/gmu-healthcare-deserts-trb.jpg" class="kar-project-link" target="_blank">
      <img src="/images/gmu-healthcare-deserts-trb.jpg" class="kar-project-card__img">
    </a>
  ...
  <div class="kar-project-card">
    ...
    <a href="/images/Florida_OD_flow_map.jpg" class="kar-project-link" target="_blank">
      <img src="/images/Florida_OD_flow_map.jpg" class="kar-project-card__img">
    </a>
  ...
  <div class="kar-project-card">
    ...
    <a href="/images/walking-impedance.png" class="kar-project-link" target="_blank">
      <img src="/images/walking-impedance.png" class="kar-project-card__img">
    </a>

    <a href="#" class="kar-project-link" target="_blank">
      <img src="/images/inclusive-access.png" class="kar-project-card__img">
    </a>
