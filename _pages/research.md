...
{% for project in site.data.research_projects %}
  <div class="kar-project-card">
    <div class="kar-project-card__title">
      <a href="{{ project.link }}" class="kar-project-link"{% if project.link contains 'http' %} target="_blank"{% endif %}>
        {{ project.title }}
      </a>
    </div>
    ...
    <a href="{{ img }}" class="kar-project-link" target="_blank">
      <img src="{{ img }}" class="kar-project-card__img">
    </a>
    {% endfor %}
